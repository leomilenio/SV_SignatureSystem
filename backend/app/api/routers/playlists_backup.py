...
def get_playlist(
    ...
    for pm in playlist_medias:
        ...
        if filepath and not filepath.startswith('/uploads/'):
            # Si el filepath tiene formato antiguo, extraer solo el nombre del archivo
            import os
        ...
        media_data = {
            ...
            "filepath": filepath,  # Filepath corregido
            "media_type": pm.media.media_type,
            "duration": pm.media.duration,  # Duración original del media
            "playlist_duration": pm.duration,  # Duración específica en esta playlist
            "effective_duration": effective_duration,  # Duración efectiva que se usará
